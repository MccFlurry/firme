...
Documento de nivel producción: describe qué campos necesita Prometido para operar,
...
Prometido no necesita ver los datos completos de una persona para detectar que
...
sistema de calidad de venta —no solo Prometido— pueda operar, WIN necesita
